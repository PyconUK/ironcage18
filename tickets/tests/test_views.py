...
class TicketTests(TestCase):
    def test_ticket(self):
        ...
        self.assertContains(rsp, '<th>Ticket holder</th><td>Alice</td>', html=True)
        self.assertContains(rsp, '<th>Days</th><td>Thursday, Friday, Saturday</td>', html=True)
        self.assertContains(rsp, '<th>Cost (incl. VAT)</th><td>126</td>', html=True)
